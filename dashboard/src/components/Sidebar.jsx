...
const Sidebar = () => {
    ...
    const activeLink = 'flex items-center gap-5 pl-4 pd-3 pb-2.5 rounded-lg text-white text-md m-2'
    const normalLink = 'flex items-center gap-5 pl-4 pd-3 pb-2.5 rounded-lg text-white text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2'
